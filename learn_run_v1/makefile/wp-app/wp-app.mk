...
# 	# check build WP_CLI_IMAHE_NAME
	...
	cp -f wp-app/.env $(WP_APP_PROJECT_PATH)/.env
	
	cp -f wp-app/wp-config.php $(WP_APP_PROJECT_PATH)/wp-config.php

	cp -f wp-app/default.conf $(WP_APP_PROJECT_PATH)/default.conf
	cp -f wp-app/index.html $(WP_APP_PROJECT_PATH)/index.html
	cp -f wp-app/phpinfo.php $(WP_APP_PROJECT_PATH)/phpinfo.php
	cp -f wp-app/test-env.php $(WP_APP_PROJECT_PATH)/test-env.php
